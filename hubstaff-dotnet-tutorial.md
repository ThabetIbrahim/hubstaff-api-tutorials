...
Download the sample application and open the application in your editor of choice. First you will edit the hubstaff `config.cs` file and add the `App-Token` you generated from the Hubstaff developer page.
